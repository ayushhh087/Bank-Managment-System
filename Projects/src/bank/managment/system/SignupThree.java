		...
		if(ae.getSource() == submit)
		{
			...
			try 
			{
				if(accounType.equals(""))
				{
					...
					Conn conn = new Conn();
					String query1 = "insert into signupthree values('"+sformno+"','"+accounType+"','"+cardnumber+"','"+pinnumber+"','"+facility+"')";
					String query2 = "insert into login values('"+sformno+"','"+cardnumber+"','"+pinnumber+"')";
